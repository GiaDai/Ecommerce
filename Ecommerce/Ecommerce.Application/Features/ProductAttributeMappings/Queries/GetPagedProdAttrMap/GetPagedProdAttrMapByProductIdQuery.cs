...
{
    public class GetPagedProdAttrMapByProductIdQuery : IRequest<Response<object>>
    {
    ...
    public class GetPagedProdAttrMapByProductIdHandler : IRequestHandler<GetPagedProdAttrMapByProductIdQuery, Response<object>>
    {
        ...
        public async Task<Response<object>> Handle(GetPagedProdAttrMapByProductIdQuery request, CancellationToken cancellationToken)
        {
            var validFilter = _mapper.Map<GetPagedProdAttrMapByProductIdParameter>(request);
