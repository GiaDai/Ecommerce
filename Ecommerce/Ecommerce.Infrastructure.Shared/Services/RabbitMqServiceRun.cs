...
{
    public class RabbitMqServiceRun : IRabbitMqServiceRun, IDisposable
    {
        ...
        public RabbitMqServiceRun(IConnectionFactory connectionFactory)
        {
    ...
    public interface IRabbitMqServiceRun
    {
